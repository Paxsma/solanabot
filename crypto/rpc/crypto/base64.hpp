...
static constexpr std::array<std::int32_t, 256u> B64index = {
...
__inline const std::string base64_encode(const char* const data, const std::size_t len) {
...
inline const std::string base64_decode(const void* data, const size_t& len) {
	if (len == 0) return "";
